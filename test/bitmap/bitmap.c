/*  Kodearen sortzailearen informazioa:
    ...
    CONTACT: {Website: http://layerlab.org/about/ ; Github Profile: https://github.com/ryanlayer}
    REPO: https://github.com/ryanlayer/cs 
    FILE LINK: https://github.com/ryanlayer/cs/blob/master/bitmap/bitmap.c
*/
#define _GNU_SOURCE
